...
public class WCFormGenerationImpl {
	...
	private final String wccontentFetchURL = "http://localhost:2018/IntegrationRest/wccontent/getAll";
	...
	public SourceType formGen(SourceType sourceType) throws Exception {
		...
		WcType content = RoutingServiceImpl.getContentAll(wccontentFetchURL, fr);
