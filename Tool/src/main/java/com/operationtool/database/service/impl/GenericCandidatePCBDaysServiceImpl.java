...
@Service
public abstract class GenericCandidatePCBDaysServiceImpl<E, K> implements GenericCandidateBillPCBAmountService<E, K> {

	private GenericCandidateBillPCBAmountService<E, K> genericImplDao;

	public GenericCandidatePCBDaysServiceImpl(GenericCandidateBillPCBAmountService<E, K> genericImplDao) {
		this.genericImplDao = genericImplDao;
	}

	public GenericCandidatePCBDaysServiceImpl() {
	}
