...
@JsonPropertyOrder({ "chart", "credits", "title", "subtitle", "plotOptions", "tooltip", "series" })
public class HighChart implements Serializable {
	...
	@JsonProperty("series")
	@Valid
	private List<Series_2> series = new ArrayList<Series_2>();
	...
	@JsonProperty("series")
	public List<Series_2> getSeries() {
		return series;
	}

	@JsonProperty("series")
	public void setSeries(List<Series_2> series) {
		this.series = series;
	}

	public void nullSeries() {
		this.series = new ArrayList<Series_2>();
	}
