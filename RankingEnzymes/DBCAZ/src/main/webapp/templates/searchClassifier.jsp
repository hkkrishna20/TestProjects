...
.dataTables_length select {
	...
	background: linear-gradient(hotpink, hotpink) no-repeat,
		linear-gradient(-135deg, rgba(255, 255, 255, 0) 50%, white 50%)
		no-repeat, linear-gradient(-225deg, rgba(255, 255, 255, 0) 50%, white
		50%) no-repeat, linear-gradient(hotpink, hotpink) no-repeat;
...
<script>
	...
	var fungiCAZymes = [ "AA2_cyt", "AA", "AA10", "AA11", "AA11_dist", "AA12",
			...
			"Cellulose Degrading", "Hemicellulose Degrading",
			"Lignin Degrading", "Pectin Degrading", "Starch Degrading",
			"Inulin" ];
						...
						$("#myInputIdButton")
								.click(
										function() {
											...
											var Url = 'http://http://localhost/classifier/searchClassifier/'
													+ orderCriteria + '/'
													+ myInput;
											$
													.ajax({
														...
														success : function(
															...
															table
																	.setAttribute(
																			'class',
																			'row-border hover order-column cell-border compact stripe  table-striped');
...
<nav
	...
	<div class="container container-fluid">
	    <a class="navbar-brand mx-auto" href="about"><u>Home</a></u>
		<a class="navbar-brand mx-auto" href="searchClassifier">CBRF-CAZymes Based<span>Ranking of Fungi</span></a>
	</div>
</nav>
<div class="row"
...
<div class="wrapper container-fluid">
	<div class="row ">
	 ...
	 -->
				<div style="margin-left: 2% !important;"
					class="autocomplete  absolute" role="menu">
					...
					<div class="form-group">
						<label for="contain">Contains the words</label> <input
							...
							placeholder="Search for CAZymes" />
					</div>
					<div class="form-group">
			...
			<div class="row ">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							<td>C&nbsp;</td>
							<td>Cellulose Degrading&nbsp;</td>
						</tr>
						<tr>
							<td>H&nbsp;</td>
							<td>Hemi-Cellulose Degrading&nbsp;</td>
						</tr>
						<tr>
							<td>Li&nbsp;</td>
							<td>Lignin Degrading&nbsp;</td>
						</tr>
						<tr>
							<td>Pe&nbsp;</td>
							<td>Pectin Degrading&nbsp;</td>
						</tr>
						<tr>
							<td>St &nbsp;</td>
							<td>Starch Degrading&nbsp;</td>
						</tr>
						<tr>
							<td>In&nbsp;</td>
							<td>Inulin Degrading&nbsp;</td>
						</tr>
						<tr>
							<td>A.Len&nbsp;</td>
 ...
 -->
		...
		<div class="col-md-10 col-lg-10 col-sm-10 col-xs-10 inner_div "
			align="left">
