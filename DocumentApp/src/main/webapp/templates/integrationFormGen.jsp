						...
						<div class="form-group">
							<div class="pure-control-group">
								<label class="col-sm-4 control-label" for="textinput">Form
									ID :</label>
								<div class="col-sm-8">
									<input type="text" name="formIDFormGen" id="formIDFormGen"
										placeholder="formIDFormGen" value="" class="form-control">
						...
						<div class="form-group">
							<div class="pure-control-group">
								<label class="col-sm-4 control-label" for="textinput">Form
									Title :</label>
								<div class="col-sm-8">
									<input type="text" name="formTitleFormGen"
										id="formTitleFormGen" placeholder="formTitleFormGen" value=""
										class="form-control">
						...
						<div class="form-group">
							<div class="pure-control-group">
								<label class="col-sm-4 control-label" for="textinput">Form
									Sequence No :</label>
								<div class="col-sm-8">
									<input type="text" name="formSeqFormGen" id="formSeqFormGen"
										placeholder="formSeqFormGen" value="" class="form-control">
