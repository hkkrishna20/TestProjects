...
body {
	...
	height: 500px;
	background-image: url("http://backgroundcheckall.com/wp-content/uploads/2017/12/bootstrap-background-9.jpg");
}
...
.gradient {
	...
	background: url(http://www.solidbackgrounds.com/images/2560x1440/2560x1440-baby-blue-solid-color-background.jpg) no-repeat;
}
*/
.gradient {
	/* Center Positioning */
	...
	/* Fallback */
	background-image:
		url(http://www.solidbackgrounds.com/images/2560x1440/2560x1440-baby-blue-solid-color-background.jpg);
...
<body>
	...
	<div id="wrapper">
		...
		<sf:form name="login-form" class="login-form" action="doLogin"
			...
			<div class="content">
				<br /> <input name="loginUserId" type="text" class="input username"
					placeholder="Username" />

				<div class="user-icon"></div>
				<input name="loginPassword" type="password" class="input password"
